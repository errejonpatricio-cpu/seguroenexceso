...
export default function Home() {
  ...
  useEffect(() => {
    const initCal = () => {
      ...
      const Cal = win.Cal || function(...args: any[]) {
        const cal = win.Cal
        if (!cal.loaded) {
          cal.ns = {}
          cal.q = cal.q || []
      ...
      Cal.ns["30min"]("inline", {
        ...
        calLink: "emiliano-alcazar-ws5auk/30min",
      })
      Cal.ns["30min"]("ui", {
        theme: "light",
        cssVarsPerTheme: { light: { "cal-brand": "#002E6F" } },
    ...
    <main className="min-h-screen font-sans overflow-x-hidden">
      ...
      <section className="relative overflow-hidden min-h-screen flex flex-col" style={{ backgroundColor: "#0a1a3a" }}>
        ...
        <div className="relative z-10 flex-1 flex flex-col md:flex-row items-center px-6 md:px-12 pb-16 gap-12">
          ...
          {/* Right side - Image with overlaid stat banners */}
          <div className="flex-1 flex items-center justify-center animate-fade-in" style={{ animationDelay: "0.5s" }}>
            <div className="relative w-full max-w-md aspect-square">
              ...
              {/* Glassmorphism stat banners overlaid at bottom of image */}
              <div className="absolute bottom-4 left-4 right-4 flex gap-2 z-10">
                {/* First banner: 100% en línea */}
                <div
                ...
                {/* Third banner: Póliza en 24hrs (reversed format) */}
                <div
                  className="flex-1 flex flex-col items-center justify-center py-4 px-3 rounded-2xl backdrop-blur-lg"
                  style={{
                    backgroundColor: "rgba(45, 65, 100, 0.5)",
      ...
      <section id="candidato" style={{ backgroundColor: "#ffffff" }} className="px-6 py-16 md:px-12 md:py-24">
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            <h2 className="text-3xl md:text-4xl font-bold mb-10" style={{ color: "#0a1a3a" }}>
              ¿Eres candidato?
            </h2>
          </AnimatedSection>
      ...
      <section style={{ backgroundColor: "#f1f5f9" }} className="px-6 py-16 md:px-12 md:py-20">
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: "#0a1a3a" }}>
        ...
        <div className="max-w-5xl mx-auto">
          <AnimatedSection>
            <div className="text-center mb-12">
              <p className="text-lg uppercase tracking-widest mb-3 font-semibold" style={{ color: "#1565c0" }}>
                Protección completa
              </p>
              <h2 className="text-3xl md:text-4xl font-bold" style={{ color: "#0a1a3a" }}>
                Coberturas del Seguro en Exceso
              </h2>
              <p className="text-base mt-4 max-w-2xl mx-auto" style={{ color: "#64748b" }}>
                Tu póliza incluye coberturas estándar y opciones personalizables para adaptarse a tus necesidades.
              </p>
            </div>
          </AnimatedSection>
                      ...
                      {[
                        ...
                        >
                          ...
                          <td className="py-3 text-center">
                            <Check className="w-5 h-5 mx-auto" style={{ color: "#1565c0" }} />
                          </td>
                        </tr>
                      ))}
                    </tbody>
          ...
          <AnimatedSection delay={300}>
            <p className="text-sm mt-8 text-center" style={{ color: "#64748b" }}>
              Las coberturas y costos exactos se revisan y personalizan durante tu cita con un asesor especializado.
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: "#0a1a3a" }} className="px-6 py-16 md:px-12 md:py-24">
        <div className="max-w-5xl mx-auto">
          <AnimatedSection>
            <p className="text-xs uppercase tracking-widest mb-4 font-medium" style={{ color: "#60a5fa" }}>
              Respaldado por
            </p>
            ...
            {[
              ...
              <AnimatedSection key={stat} delay={i * 100}>
                <div
                  ...
                  style={{ backgroundColor: "rgba(255,255,255,0.05)", border: "1px solid rgba(96,165,250,0.2)" }}
                >
          ...
          <AnimatedSection delay={400}>
            <p className="text-base leading-relaxed max-w-2xl" style={{ color: "#bfdbfe" }}>
              MAPFRE emite y opera tu póliza. Una de las aseguradoras más sólidas del mundo.
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: "#ffffff" }} className="px-6 py-16 md:px-12 md:py-24">
        <div className="max-w-5xl mx-auto">
          <AnimatedSection>
            <p className="text-xs uppercase tracking-widest mb-4" style={{ color: "#1565c0" }}>
              Tu agente de confianza
            </p>
            <h2 className="text-3xl md:text-4xl font-bold mb-12" style={{ color: "#0a1a3a" }}>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <AnimatedSection delay={500}>
            <div
              ...
              style={{ boxShadow: "0 4px 24px rgba(251,146,60,0.15)" }}
            >
              {/* Top accent bar */}
              <div className="h-1 w-full" style={{ background: "linear-gradient(90deg, #f59e0b, #fb923c)" }} />
              <div
                className="p-5 flex items-start gap-4"
                style={{ backgroundColor: "#fffbeb", border: "1px solid #fde68a", borderTop: "none" }}
              >
                {/* Icon with warm circle background */}
                <div
      ...
      <section style={{ backgroundColor: "#ffffff" }} className="px-6 py-16 md:px-12 md:py-24">
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            <h2 className="text-3xl md:text-4xl font-bold mb-2" style={{ color: "#0a1a3a" }}>
            ...
            <Accordion type="single" collapsible className="w-full space-y-3">
              {[
                ...
                },
                {
                  ...
                  a: "Tu antigüedad puede reconocerse al hacer la transición del seguro colectivo a la póliza en exceso, ayudando a evitar o reducir periodos de espera y manteniendo la continuidad de tu cobertura — sin empezar de cero. Esto depende del diseño específico de tu póliza.",
                },
                {
                  q: "¿Las preexistencias están cubiertas?",
                  a: "No. Un padecimiento diagnosticado antes de contratar sigue siendo preexistencia y no está cubierto. Por eso el momento ideal para contratar es ahora, mientras estás sano: todo lo que aparezca después de la contratación s�� puede quedar cubierto, ya sea dentro o fuera de tu póliza colectiva.",
                },
                {
                ...
                {
                  q: "¿Qué pasa si mi empresa cambia de aseguradora?",
                  a: "En la mayoría de los casos, tu póliza en exceso puede seguir operando sobre el nuevo seguro de grupo sin perder continuidad. Cuando eso ocurre, EB&A revisa el nuevo plan y ajusta la estructura si es necesario.",
                },
              ].map(({ q, a }, i) => (
                <AccordionItem
                  key={i}
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: "#0a1a3a" }}>
                Agenda tu cita
              </h2>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row md:justify-between gap-10">
            ...
            <div className="text-sm space-y-2" style={{ color: "#bfdbfe" }}>
              <p>
                <span className="font-medium text-white">CDMX:</span> Mariano Escobedo 556, Col. Anzures, 11590 CDMX
              </p>
              <p>Tel: 55 5029 1400</p>
              <p className="mt-4">
                <span className="font-medium text-white">QRO:</span> Hacienda de Buenavista #310-7, Jardines de la Hacienda
              </p>
