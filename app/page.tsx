...
const faqItems = [
  {
    q: "Mi póliza de grupo ya tiene cláusula de conversión, ¿para qué necesito una póliza en exceso?",
    a: "La cláusula de conversión solo te permite salir del seguro colectivo y pasar a una póliza individual con los mismos términos y condiciones, es decir la misma suma asegurada. La póliza en exceso hace algo distinto: suma protección adicional hoy, mientras sigues en la empresa, y se convierte en tu póliza principal el día que la necesites.",
  },
  {
    q: "Mi póliza colectiva no es de MAPFRE, ¿aún así puedo contratar?",
    a: "Sí. La póliza en exceso funciona como complemento de cualquier seguro de grupo, sin importar qué aseguradora lo opera.",
  },
  {
    q: "¿Cuándo recibo mi póliza?",
    a: "En menos de 24 horas después de completar tu cotización y cuestionario médico — siempre que no se requieran estudios adicionales. Todo por correo electrónico.",
  },
  {
    q: "¿Cómo hago una reclamación con mi póliza en exceso?",
    a: "El proceso es en dos capas: primero se atiende el siniestro con tu seguro de empresa hasta su límite. Si el gasto lo supera, tu póliza en exceso se activa como segunda capa, siguiendo el procedimiento de reclamación de MAPFRE. EB&A te acompaña en cada paso.",
  },
  {
    q: "¿Qué pasa con mi antigüedad al salir de la empresa?",
    a: "Tu antigüedad se respeta desde hoy que contratas tu póliza en exceso. Solo necesitamos tu certificado de antigüedad actual para tramitarlo.",
  },
  {
    q: "¿Las preexistencias están cubiertas?",
    a: "No. Un padecimiento diagnosticado antes de contratar sigue siendo preexistencia y no está cubierto. Por eso el momento ideal para contratar es ahora, mientras estás sano: todo lo que aparezca después de la contratación se queda cubierto, ya sea dentro o fuera de tu póliza colectiva.",
  },
  {
    q: "¿EB&A es lo mismo que MAPFRE?",
    a: "No. EB&A es tu broker: te asesora, gestiona tu póliza y te acompaña en todo el proceso. MAPFRE es la aseguradora que emite y respalda tu póliza. Roles distintos, equipo completo.",
  },
  {
    q: "¿A quién pago las primas?",
    a: "El pago se realiza directamente a MAPFRE mediante sus conductos de cobro oficiales.",
  },
  {
    q: "¿Cuál es el mejor momento para contratar?",
    a: "Ahora. La póliza en exceso se contrata con salud, no cuando ya hay un diagnóstico. Entre más pronto la tengas, más completa y accesible es tu protección.",
  },
  {
    q: "¿Qué pasa si nunca la uso?",
    a: "Es como el cinturón de seguridad: esperas no necesitarlo nunca. Pero si algún día tu cuenta hospitalaria supera la suma asegurada de tu empresa, tu póliza en exceso protege tu patrimonio. Esa tranquilidad no tiene precio.",
  },
  {
    q: "¿Qué pasa si mi empresa cambia de aseguradora o Suma Asegurada?",
    a: "Si tu Suma Asegurada cambia, tu póliza en exceso deberá actualizarse para reflejar los nuevos términos. Si solo cambia la aseguradora, tu póliza en exceso sigue operando normalmente. Recuerda que tu deducible debe ser igual a tu Suma Asegurada de grupo.",
  },
]
  ...
  return (
    <main className="min-h-screen font-sans overflow-x-hidden">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 shadow-lg px-5 py-3 rounded-full text-white text-sm font-semibold transition-all hover:scale-105 hover:shadow-xl"
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-4">
            {[
              ...
              <AnimatedSection key={item} delay={i * 100}>
                <div
                  className="flex items-start gap-4 p-4 rounded-lg transition-all hover:shadow-md hover:scale-[1.02]"
                  style={{ backgroundColor: "#f8fafc" }}
                >
                  <span
          ...
          <AnimatedSection delay={400}>
            <p
              className="text-sm mt-6 p-4 rounded-lg"
              style={{ color: "#6b7280", backgroundColor: "#fef3c7" }}
            >
              *Si cuentas con alguna condición preexistente, aún puedes aplicar
              — tu caso se evalúa a través de un proceso de selección médica
              personalizada. Agenda tu cita y te orientamos sin compromiso.
            </p>
          </AnimatedSection>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            ...
            <p
              ...
              style={{ color: "#475569" }}
            >
              Pueden contratar todos los miembros registrados en la póliza
              colectiva de su empresa: <strong>titular, cónyuge e hijos
              dependientes</strong>, siempre que cumplan con los requisitos de
              candidato y se encuentren activos en la póliza colectiva.
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <AnimatedSection>
            <div className="text-center mb-12">
              <p
                className="text-lg uppercase tracking-widest mb-3 font-semibold"
                style={{ color: "#1565c0" }}
              >
                Protección completa
              </p>
              <h2
                ...
                style={{ color: "#0a1a3a" }}
              >
                Coberturas del Seguro en Exceso
              </h2>
              <p
                className="text-base mt-4 max-w-2xl mx-auto"
                style={{ color: "#64748b" }}
              >
                Puedes contratar hasta 130 Millones de pesos de Suma Asegurada.
              </p>
            </div>
          </AnimatedSection>
          <div className="grid md:grid-cols-2 gap-8">
            <AnimatedSection delay={100}>
              <div
                className="rounded-xl overflow-hidden h-full transition-all hover:shadow-lg"
                style={{ border: "1px solid #e2e8f0" }}
              >
                <div
                  className="p-6"
            ...
            <AnimatedSection delay={200}>
              ...
              >
                ...
                >
                  ...
                  <p
                    className="text-sm mt-1 text-blue-100"
                  >
                    Adapta tu cobertura a tus necesidades
                  </p>
                </div>
                <div
                  className="p-6"
                  ...
                  <table className="w-full">
                    <thead>
                      <tr>
                        ...
                        <th
                          className="text-right text-sm font-medium pb-4"
                          style={{ color: "#64748b" }}
                        >
                          Opciones
                        </th>
                      ...
                      {[
                        {
                          ...
                          value: "Óptima / Premium",
                          desc: "Elige tu red de hospitales",
                        },
                        {
                          name: "Tabulador Médicos",
                          value: "A, B, C, D o E",
                          desc: "Define tu nivel de cobertura",
                        },
                        {
                          name: "Plan Dental",
                          value: "Disponible",
                          desc: "Cobertura dental opcional",
                        },
                        {
                          name: "Plan Visión",
                          value: "Disponible",
                          desc: "Cobertura óptica opcional",
                        },
                      ].map(({ name, value, desc }) => (
                        <tr
                          key={name}
          ...
          <AnimatedSection delay={300}>
            <p
              ...
              style={{ color: "#64748b" }}
            >
              Las coberturas y costos exactos se revisan y personalizan durante
              tu cita con un asesor especializado.
            </p>
          </AnimatedSection>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <AnimatedSection delay={400}>
            <p
              ...
              style={{ color: "#bfdbfe" }}
            >
              MAPFRE emite y opera tu póliza. Una de las aseguradoras más
              sólidas del mundo.
            </p>
          </AnimatedSection>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <AnimatedSection>
            ...
            <h2
              ...
              style={{ color: "#0a1a3a" }}
            >
              EB&A gestiona tu póliza con MAPFRE
            </h2>
          </AnimatedSection>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
            {[
              ...
              <AnimatedSection key={stat} delay={i * 100}>
                <div
                  className="p-6 rounded-xl transition-all hover:shadow-md hover:scale-105"
                  style={{
          ...
          <AnimatedSection delay={400}>
            <p
              ...
              style={{ color: "#475569" }}
            >
              EB&A es el broker autorizado por la CNSF que gestiona tu
              contratación, administra tu póliza, maneja la cobranza y te
              acompaña en cada etapa, incluyendo en caso de siniestro. Somos el
              puente entre tú y MAPFRE.
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      >
        <div className="max-w-5xl mx-auto">
            ...
            {[
              {
                ...
                desc: "Elige el día y hora que mejor te acomode.",
              },
              {
                icon: Video,
                title: "Videollamada 20 min",
                desc: "Cuestionario médico breve y datos biométricos.",
              },
              {
                icon: CreditCard,
                title: "Pagas con tarjeta",
                desc: "Pago seguro en línea al finalizar.",
              },
              {
                icon: Receipt,
                title: "Recibes tu póliza",
                desc: "En menos de 24 horas en tu correo.",
              },
            ].map(({ icon: Icon, title, desc }, i) => (
              <AnimatedSection key={title} delay={i * 100}>
                <div
                  className="relative p-6 rounded-xl bg-white transition-all hover:shadow-lg hover:scale-105"
                  style={{ border: "1px solid #e2e8f0" }}
                >
                  <div
          ...
          <AnimatedSection delay={500}>
            <div
              className="mt-10 rounded-2xl overflow-hidden transition-all hover:shadow-lg"
              style={{
            ...
            >
              ...
              >
                ...
                <div>
                  <p
                    className="font-bold text-sm mb-1 uppercase tracking-wide"
                    style={{ color: "#b45309" }}
                  >
                    Tip importante
                  </p>
                  <p
                    ...
                    style={{ color: "#78350f" }}
                  >
                    Para hacer válida tu Póliza en Exceso ante cualquier
                    siniestro, necesitarás presentar también tu certificado de
                    seguro colectivo. Tenlo a la mano desde hoy.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            <h2
              ...
              style={{ color: "#0a1a3a" }}
            >
              ¿Qué necesitas para tu cita?
            </h2>
            <p
              className="mb-10 text-base"
              style={{ color: "#64748b" }}
            >
              Prepárate en menos de 5 minutos.
            </p>
          </AnimatedSection>
          <div className="grid md:grid-cols-2 gap-4">
            {[
              {
                icon: Monitor,
                text: "Dispositivo con cámara y micrófono (celular o computadora)",
              },
              ...
              {
                icon: FileText,
                text: "Certificado o credencial de tu póliza colectiva (recomendable, no indispensable)",
              },
            ].map(({ icon: Icon, text }, i) => (
              <AnimatedSection key={text} delay={i * 80}>
                <div
                  className="flex items-start gap-4 p-4 rounded-xl transition-all hover:shadow-md hover:scale-[1.02]"
                  style={{
                    backgroundColor: "#f8fafc",
                    border: "1px solid #e2e8f0",
                  }}
        ...
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            ...
            <p
              ...
              style={{ color: "#64748b" }}
            >
              Preguntas frecuentes sobre el Seguro en Exceso
            </p>
          </AnimatedSection>
          <AnimatedSection delay={100}>
            <Accordion
            ...
            >
              {faqItems.map(({ q, a }, i) => (
                ...
                >
                  <AccordionTrigger
                    className="text-left text-base font-medium px-6 py-4 hover:no-underline"
                    style={{ color: "#0a1a3a" }}
                  >
                    {q}
                  </AccordionTrigger>
                  <AccordionContent
                    className="text-sm leading-relaxed px-6 pb-4"
                    style={{ color: "#475569" }}
                  >
                    {a}
                  </AccordionContent>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <AnimatedSection>
              ...
              <p
                ...
                style={{ color: "#64748b" }}
              >
                Selecciona el día y hora que mejor te acomode. La videollamada
                dura aproximadamente 30 minutos.
              </p>
              <div className="space-y-3">
                {["100% en línea", "Sin compromiso", "Asesoría personalizada"].map(
                  (item) => (
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row md:justify-between gap-10">
            <div>
              ...
              <p
                ...
                style={{ color: "#93c5fd" }}
              >
                Protección Patrimonial Personalizada
              </p>
            </div>
            <div
            ...
            >
              <p>
                <span className="font-medium text-white">CDMX:</span> Mariano
                Escobedo 556, Col. Anzures, 11590 CDMX
              </p>
              <p>Tel: 55 5029 1400</p>
              <p className="mt-4">
                <span className="font-medium text-white">QRO:</span> Hacienda de
                Buenavista #310-7, Jardines de la Hacienda
              </p>
            ...
            >
              <a
                href="mailto:patricio@ebya.mx"
                className="hover:text-white transition-colors"
                onClick={() =>
                  posthog.capture("contact_email_clicked", {
                    email: "patricio@ebya.mx",
                  })
                }
              >
                patricio@ebya.mx
          ...
          >
            © {new Date().getFullYear()} EB&A Protección Patrimonial. Todos los
            derechos reservados.
          </div>
        </div>
      </footer>
